...
# -halt-on-error: остановиться сразу при ошибке валидации (см. config.tex)
pdflatex -halt-on-error -interaction=nonstopmode -output-directory=../exam_cards main.tex
pdflatex -halt-on-error -interaction=nonstopmode -output-directory=../exam_cards main.tex
